...
namespace RitoBot
{
    class RiotBot
    {
        ...
        public RiotBot(string username, string password, string reg, string path, int threadid, QueueTypes QueueType ,int tmp_colanchoi = 999)
        {
            ...
            solanchoi = tmp_colanchoi;
        }

        public int solanchoi = 1;
        public int solandachoi = 1;
        ...
        {
                updateStatus("Khởi động lại League of Legends.", Accountname);
                Thread.Sleep(1000);
        ...
        private void connection_OnLoginQueueUpdate(object sender, int positionInLine)
        {
            ...
            {
                this.updateStatus("Đang ở hàng chờ . Đợi tí : " + (object)positionInLine, Accountname);
            }
        ...
        private void connection_OnDisconnect(object sender, EventArgs e)
        {
            ...
            this.updateStatus("Ngắt kết nối !", Accountname);
        }
